...
class _AuthClient implements AuthClient {
  ...
  Future<DeviceCodeResponse> requestDeviceCode({
    required DeviceCodeRequest body,
  }) async {
    ...
    final _options = _setStreamType<DeviceCodeResponse>(
    ...
    late DeviceCodeResponse _value;
    try {
      _value = DeviceCodeResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<PostApiAuthDeviceApproveResponse> approveDeviceCode({
    required ApiAuthDeviceApproveRequestBody body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<PostApiAuthDeviceApproveResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PostApiAuthDeviceApproveResponse _value;
    try {
      _value = PostApiAuthDeviceApproveResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<SignInResponse> signInWithEmail({
    required ApiAuthSignInEmailRequestBody body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
